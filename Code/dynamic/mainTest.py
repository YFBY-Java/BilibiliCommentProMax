...
from Code.dynamic.getDynamicComments import get_comments, get_comments_TurnPage
...
def getDynamicComments(rid_str, headers):
    ...
    pn = 1
    while True:
        comments_turn_page = get_comments_TurnPage(Cookie, type_code=11, oid=rid_str, sort=0, nohot=0, ps=20, pn=pn)
